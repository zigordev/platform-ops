...
cv_github_repository    = "zigordev/cv"
...
REGION="eu-west-1"
BASE="/Users/zigordev/zigor-dev/platform-ops/infra/terraform"
...
3. For fine-grained PAT, grant repository access to `zigordev/platform-ops` with:
